...
LOGGER = logging.getLogger(__name__)  # this is the global logger
...
def load_state_dict_with_mismatch(model, loaded_state_dict_or_path):
    ...
    if len(mismatched_shape_keys) > 0:
        raise ValueError("Shape mismatched, please check the keys above")
